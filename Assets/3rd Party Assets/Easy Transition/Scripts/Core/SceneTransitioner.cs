namespace PixeLadder.EasyTransition
{
    ...
    public class SceneTransitioner : MonoBehaviour
    {
        ...
        public void LoadScene(SceneNames sceneName, TransitionEffect effect = null)
        {
        ...
        private IEnumerator TransitionRoutine(SceneNames sceneName, TransitionEffect effect)
        {
            ...
            // Load the new scene.
            yield return SceneManager.LoadSceneAsync(SceneHelper.GetSceneName(sceneName));
